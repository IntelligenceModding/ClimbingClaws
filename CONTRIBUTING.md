...
<p align="center">
  Thank you for your interest in contributing to Climbing Claws.
</p>

<p align="center">
  Contributions help improve the mod and are welcome in many forms, including bug fixes, movement improvements, enchantment improvements, compatibility improvements, code improvements, documentation changes, and other useful additions.
</p>
...
- [Developing Climbing Claws](#developing-climbing-claws)
  - [Testing](#testing)
...
Reporting bugs is one of the easiest ways to contribute to Climbing Claws.

Before opening an issue:

- check whether the problem has already been reported;
- make sure you are using a Climbing Claws version intended for your Minecraft version;
- make sure your mod loader and required dependencies are compatible with the Climbing Claws version you are using;
...
Suggestions for climbing behavior, movement options, enchantment improvements, compatibility improvements, or other features are welcome.

Before creating a feature request:

- check existing issues for similar suggestions;
- explain what the feature would add to Climbing Claws;
...
Climbing Claws uses separate branches for different Minecraft versions and mod loaders.
...
Before working on Climbing Claws, make sure you have the following installed:
...
If you are contributing through a pull request, first fork the [Climbing Claws repository][repository] to your own GitHub account.
...
Climbing Claws includes the Gradle wrapper, so installing Gradle separately is normally not necessary.
...
Running the development client is strongly recommended for changes that affect gameplay, movement, rendering, models, textures, sounds, recipes, enchantments, loot, trades, or other in-game behavior.

## Developing Climbing Claws

### Testing

Changes should be tested before being submitted.

There is currently no expectation that every contribution includes automated tests. For most Climbing Claws changes, practical in-game testing is more useful.
...
For changes affecting JEI integration, verify that the optional in-game information appears correctly and that Climbing Claws continues to work normally without the recipe viewer installed.
...
Contributions involving textures, models, sounds, or other assets are welcome where they fit the style and purpose of Climbing Claws.

When contributing assets:

- try to match the existing visual style of the mod;
- keep Minecraft's item and resource conventions in mind;
- keep new Climbing Claws content visually consistent with the existing item, enchantments, and other assets;
...
Documentation changes should be clear, accurate, and relevant to Climbing Claws.
...
By submitting code, documentation, textures, models, sounds, or other material to Climbing Claws, you confirm that you have the right to contribute that material.

Unless explicitly agreed otherwise, contributions are made under the license used by the Climbing Claws repository.
